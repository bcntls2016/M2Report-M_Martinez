...
set o "DIM-5s-pot.tex"

set key vert
set key at screen 0.90,0.90 center 
#set key box opaque
...
# plot		
plot 	E0_K ls 2 notitle, \
		(E2) ls 2 notitle, \
		"./data/5s-pp.dat" u ($1+x0):($2 + E0_K) ls 4 w l title "$5s$", \
		1 ls 6 title "4s"
...
# plot
plot 	E0_K ls 2 notitle,\
		"./data/5s-ave.dat" u 1:($2+E0_K+Eref) ls 4 w l title "$5s$",\
		1 ls 6 title "$4s$"
